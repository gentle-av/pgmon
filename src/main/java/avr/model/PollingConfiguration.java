...
@Entity @Table(name = "polling_configurations")
public class PollingConfiguration {
  ...
  public Integer getAshCollectionIntervalSeconds() {
    return ashCollectionIntervalSeconds;
  }

  public void setAshCollectionIntervalSeconds(Integer ashCollectionIntervalSeconds) {
    this.ashCollectionIntervalSeconds = ashCollectionIntervalSeconds;
  }
