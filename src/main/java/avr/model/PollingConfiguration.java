...
public class PollingConfiguration {
    ...
    private int ashCollectionIntervalSeconds = 2;
    ...
    public int getAshCollectionIntervalSeconds() { return ashCollectionIntervalSeconds; }

    public void setAshCollectionIntervalSeconds(int ashCollectionIntervalSeconds) { this.ashCollectionIntervalSeconds = ashCollectionIntervalSeconds; }
