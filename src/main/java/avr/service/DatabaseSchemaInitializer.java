...
public class DatabaseSchemaInitializer {
  ...
  private final List<String> migrationFiles = Arrays.asList("db/migration/01_credentials_table.sql",
      "db/migration/02_servers_table.sql", "db/migration/03_polling_configurations_table.sql",
      "db/migration/04_polling_history_table.sql", "db/migration/05_ash_history_table.sql",
